...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <a href="" class="btn btn-info mb-3" data-toggle="modal" data-target="#newMenuModal"><i class="fa fa-plus mr-2"></i>Tambah Menu Baru</a>
            ...
            <form action="<?= base_url('menu'); ?>" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" id="menu" name="menu" placeholder="Ketik disini">
                    </div>
                </div>
